...
public class MetadataReader {
    public static String read(String filePath) {
        ...
        try {
            ...
            result += print(metadata, "Using ImageMetadataReader\r\n");
        ...
        try {
            ...
            result += print(metadata, "Using JpegMetadataReader\r\n");
        ...
        try {
            ...
            result += print(metadata, "Using JpegMetadataReader for Exif and IPTC only\r\n");
        } catch (JpegProcessingException e) {
            result += print(e);
        } catch (IOException e) {
            result += print(e);
    ...
    private static String print(Exception exception) {
